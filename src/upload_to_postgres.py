...
def insert_data_to_postgres(conn, cursor, spark_df):
    ...
    try:
        ...
        users_insert_query = """
            INSERT INTO airflow_schema.users (gender, first_name, last_name, title, email, username)
            VALUES (%s, %s, %s, %s, %s, %s)
        """
        ...
        addresses_insert_query = """
            INSERT INTO airflow_schema.addresses (street_name, street_number, city, state, country, postcode)
            VALUES (%s, %s, %s, %s, %s, %s)
        """
        ...
        logins_insert_query = """
            INSERT INTO airflow_schema.logins (username)
            VALUES (%s)
        """
        ...
        contacts_insert_query = """
            INSERT INTO airflow_schema.contacts (phone, cell)
            VALUES (%s, %s)
        """
